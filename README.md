...
## Markdown и код в чате

В корне проекта добавлен файл `MARKDOWN_HELPER.md` с примерами, как красиво оформить текст, код, списки и таблицы для отображения в чате.
